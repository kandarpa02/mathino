...
# ============================================
# 🚀 STATIC GRAPH EXECUTOR (the thing you want)
# ============================================
...
static_test = StaticGraph(test)
print(static_test(np.array(2.), np.array(3.), np.array(4.)))
print(static_test(np.array(2.), np.array(3.), np.array(4.)))